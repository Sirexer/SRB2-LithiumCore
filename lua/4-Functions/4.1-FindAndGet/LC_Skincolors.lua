...
LC.functions.CheckName = function(self, silent)
	if self
		if self == ""
			if silent == nil
...
LC.functions.CheckRamp = function(self)
	if self
		local ramp
		if type(self) == "string"
			self = self:gsub(" ", ",")
...
LC.functions.CheckInvcolor = function(self)
	if self
...
LC.functions.CheckInvshade = function(self)
	if self
		local int = tonumber(self)
		if int
...
LC.functions.CheckChatcolor = function(self)
	if self
